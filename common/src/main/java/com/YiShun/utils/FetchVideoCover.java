...
/**
 * Created by Lanly on 2018/6/28 上午4:31
 */
...
//		ffmpeg -ss 00:00:01 -i spring.mp4 -vframes 1 bb.jpg
	...
	public static void main(String[] args) {
		// 获取视频信息
		FetchVideoCover videoInfo = new FetchVideoCover("/usr/local/Cellar/ffmpeg/4.0.1/bin/ffmpeg");
		try {
			videoInfo.getCover("/usr/local/YiShunCache/before.mp4","/usr/local/YiShunCache/before.jpg");
